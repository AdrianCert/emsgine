...
macro_rules! extract_bitcoded {
    ...
    ($v:expr, $t:tt[ 0x1f1ffff ]) => {
        (($v[1] as u32) & 0xffff | (($v[0] as u32) & 0x1) << 16 | (($v[0] as u32) & 0x1f0) << 13)
            as $t
    };
...
pub fn decode<'a>(inst: Vec<u16>) -> Result<(AvrInstructionSet, InstructionParameters<'a>), u8> {
    match 0xf000 & inst[0] {
        0x1000 => match 0xc00 & inst[0] {
            0xc00 => Ok((
                ...
                vec![
                    (
                        "rsr",
                        DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0x20f])),
                    ),
                    (
                        "rds",
        ...
        0x0 => match 0xc00 & inst[0] {
            ...
            0x0 => match 0x300 & inst[0] {
                ...
                0x0 => Ok((AvrInstructionSet::NoOperation, vec![])),
                _ => Err(0u8),
            },
            0x800 => Ok((
                ...
                0x200 => match 0x100 & inst[0] {
                    0x0 => Ok((
                        ...
                        vec![
                            (
                                "imd",
                                DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0xcf])),
                            ),
                            (
                                "rds",
                                DataWordSized::DataSizeByte({
                ...
                0x0 => match 0xe & inst[0] {
                    ...
                    0x8 => match 0x180 & inst[0] {
                        0x80 => Ok((
                            ...
                            vec![(
                                "s",
                                DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0x70])),
                            )],
                        )),
                        0x180 => match 0x70 & inst[0] {
                            0x10 => Ok((AvrInstructionSet::Break, vec![])),
                            0x50 => Ok((AvrInstructionSet::ExtendedLoadProgramMemory, vec![])),
                            0x40 => Ok((AvrInstructionSet::LoadProgramMemory, vec![])),
                            0x0 => Ok((AvrInstructionSet::Sleep, vec![])),
                            0x60 => Ok((AvrInstructionSet::StoreMemoryProgram, vec![])),
                            0x70 => {
                                Ok((AvrInstructionSet::StoreMemoryProgramPostIncrementZ, vec![]))
                            }
                            0x20 => Ok((AvrInstructionSet::WatchdogReset, vec![])),
                            _ => Err(0u8),
                        },
                        0x0 => match 0x1 & inst[0] {
                            ...
                            0x1 => match 0x70 & inst[0] {
                                0x10 => Ok((AvrInstructionSet::ExtendedIndirectJump, vec![])),
                                0x0 => Ok((AvrInstructionSet::IndirectJump, vec![])),
                                _ => Err(0u8),
                            },
                            _ => Err(0u8),
                        },
                        0x100 => match 0x70 & inst[0] {
                            0x10 => match 0x1 & inst[0] {
                                0x1 => {
                                    Ok((AvrInstructionSet::ExtendedIndirectCallSubroutine, vec![]))
                                }
                                0x0 => Ok((AvrInstructionSet::ReturnFromInterrupt, vec![])),
                                _ => Err(0u8),
                            },
                            0x0 => match 0x1 & inst[0] {
                                0x1 => Ok((AvrInstructionSet::IndirectCallSubroutine, vec![])),
                                0x0 => Ok((AvrInstructionSet::ReturnFromSubroutine, vec![])),
                                _ => Err(0u8),
                            },
                            _ => Err(0u8),
                        },
                    ...
                    0xe => {
                        ...
                        Ok((
                            ...
                            vec![(
                                "k",
                                DataWordSized::DataSizeDouble(extract_bitcoded!(
                                    inst,
                                    u32[0x1f1ffff]
                                )),
                            )],
            ...
            0x800 => match 0x300 & inst[0] {
                0x0 => Ok((
                    ...
                    vec![
                        (
                            "rio",
                            DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0xf8])),
                        ),
                        (
                            "b",
                            DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0x7])),
                        ),
                    ],
                )),
                0x200 => Ok((
        ...
        0x7000 => Ok((
            ...
            vec![
                (
                    "imd",
                    DataWordSized::DataSizeWord(extract_bitcoded!(inst, u16[0xf0f])),
                ),
                (
                    "rds",
                    DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0xf0])),
        ...
        0xb000 => match 0x800 & inst[0] {
            0x0 => Ok((
                ...
                vec![
                    (
                        "rio",
                        DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0x60f])),
                    ),
                    (
                        "rds",
                        DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0x1f0])),
            ...
            0x8 => match 0x200 & inst[0] {
                0x0 => Ok((
                    ...
                    vec![
                        (
                            "q",
                            DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0xc07])),
                        ),
                        (
                            "rds",
                            DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0x1f0])),
        ...
        0xa000 => Ok((
            ...
            vec![
                ...
                (
                    "f",
                    DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0x2])),
                ),
                (
                    "rsr",
                    DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0x1f0])),
                ...
                (
                    "a",
                    DataWordSized::DataSizeByte(extract_bitcoded!(inst, u8[0x8])),
                ),
            ],
        )), // see...,
        _ => Err(0u8),
